...
// Main Component
export default function User5(): JSX.Element {
  const formFields = [
    {
      id: "fullName",
      label: "الاسم الرباعي",
  ...
  return (
    <Card className="w-full max-w-[860px] rounded-xl border border-[#d5d6d9]">
        ...
        <Card className="w-full rounded-xl border border-[#e9e9eb] bg-white rtl">
          <CardContent className="flex items-center justify-between gap-3 p-4">
            ...
            <div className="flex flex-1 flex-col gap-1">
              <div className="text-sm font-medium text-[#414651]">شهادة خالد</div>
              <div className="text-sm font-normal text-[#535861]">حجم الملف</div>
            </div>
            <Button
              variant="outline"
              size="sm"
