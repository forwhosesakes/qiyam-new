...
export const Section2 = (): JSX.Element => {
  return (
    <Card className="flex flex-col w-full max-w-[1205px] items-end gap-[42px] p-4 rounded-3xl shadow-shadows-shadow-md">
      <img
      ...
      <CardContent className="flex flex-col items-end justify-center gap-6 w-full p-0">
        <h1 className="[font-family:'Ping_AR_+_LT-Bold',Helvetica] font-bold text-[32px] leading-7 [direction:rtl] w-full text-[#1f2a37] tracking-[0]">
        ...
        <div className="flex flex-col items-start gap-4 w-full">
          {paragraphs.map((paragraph, index) => (
            <p
              key={index}
              className="[font-family:'Ping_AR_+_LT-Regular',Helvetica] font-normal text-2xl text-justify leading-[33.6px] w-full text-[#1f2a37] tracking-[0]"
            >
              {paragraph}
            </p>
          ))}
