          ...
          <div className="flex flex-col items-center gap-4 self-stretch w-full">
            <div className="inline-flex items-center gap-3 pl-1 pr-2.5 py-1 bg-white rounded-[10px] border-[#d5d6d9] shadow-shadows-shadow-xs border border-solid">
              <div className="inline-flex gap-1 items-center">
                <span className="[font-family:'Ping_AR_+_LT-Medium',Helvetica] font-medium text-[#414651] text-sm text-left tracking-[0] leading-5 whitespace-nowrap [direction:rtl]">
              ...
              <Badge className="gap-1.5 px-2 py-0.5 bg-[#68c35c1f] text-[#006173] rounded-md border-[#539c4a57] border border-solid">
                <span className="[font-family:'Ping_AR_+_LT-Medium',Helvetica] font-medium text-sm text-center tracking-[0] leading-5 whitespace-nowrap [direction:rtl]">
                  مميزات جديدة
                </span>
            ...
            <h1 className="self-stretch font-display-xl-semibold font-[number:var(--display-xl-semibold-font-weight)] text-[#181d27] text-[length:var(--display-xl-semibold-font-size)] text-center tracking-[var(--display-xl-semibold-letter-spacing)] leading-[var(--display-xl-semibold-line-height)] [direction:rtl] [font-style:var(--display-xl-semibold-font-style)]">
              برنامج التمكين التطوعي للطالبات
            </h1>
          </div>

          <p className="[font-family:'Ping_AR_+_LT-Regular',Helvetica] font-normal text-[#535861] text-xl text-center tracking-[0] leading-[30px] [direction:rtl]">
