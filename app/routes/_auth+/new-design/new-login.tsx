        ...
        <div className="flex flex-col max-w-[360px] gap-8 w-full items-center">
          ...
          <Card className="w-full border-none shadow-none">
            <CardContent className="p-0 flex flex-col gap-6">
              <div className="flex flex-col items-start gap-5 w-full">
                ...
                <div className="flex flex-col items-end gap-1.5 w-full">
                  ...
                  <div className="w-full relative">
                    <Input
                      type="password"
                      className="flex items-center gap-2 px-3.5 py-2.5 bg-white rounded-lg border border-solid border-[#fca19b] shadow-shadows-shadow-xs text-right [direction:rtl]"
                      defaultValue="••••••••"
                    />
                    <AlertCircleIcon className="absolute right-3.5 top-1/2 transform -translate-y-1/2 w-4 h-4 text-destructive" />
                  </div>
              ...
              {/* Login button */}
              <div className="w-full">
                <Button className="w-full bg-[#006A61] hover:bg-[#005A51] text-white rounded-lg py-2.5 [font-family:'Ping_AR_+_LT-Medium',Helvetica] font-medium text-base [direction:rtl]">
                  تسجيل الدخول
                </Button>
              </div>
            </CardContent>
