    ...
    <section className="flex flex-col max-w-screen-xl w-full items-center gap-8 px-8 py-0 mx-auto ">
      <div className="flex flex-col gap-12 self-stretch w-full items-center" >
        ...
        <div className="inline-flex items-start gap-3">
          ...
          <button className="flex items-center justify-center px-[26px] py-4 bg-[#006173] text-white rounded-[10px]">
            <span className="[font-family:'Ping_AR_+_LT-Bold',Helvetica] font-bold text-lg text-left tracking-[0] leading-7 whitespace-nowrap ">
              للتسجيل
            </span>
          </button>
        </div>
