...
import Group30538 from "../assets/images/new-design/Group 30538.png"
import Group30543 from "../assets/images/new-design/Group.png"
          ...
          <div className="flex flex-col max-w-screen-md items-center gap-5 relative w-full">
            <div className="flex flex-col items-center gap-3 relative self-stretch w-full">
              <Badge
                ...
                className="bg-neutral-50 border-[#e9e9eb] px-2.5 py-1 rounded-md"
              >
      ...
      >
        <CardContent className="flex items-center justify-center gap-[135px] p-3 h-full">
          ...
          <div className="flex flex-col w-[702px] items-end gap-7">
            ...
            <p className="w-[806px] ml-[-104.00px]  font-medium text-white text-2xl text-justify tracking-[0] leading-[34px] [direction:rtl]">
