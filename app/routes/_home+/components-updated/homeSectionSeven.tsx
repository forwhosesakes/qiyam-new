...
export const HomeSectionSeven = (): JSX.Element => {
  ...
  return (
    <div className="relative w-full max-w-[1280px] h-[434px] m-auto mt-[110px]">
          ...
          <div className="flex flex-col items-center gap-12 relative self-stretch w-full">
            <div className="flex flex-col max-w-screen-md items-center gap-5 relative w-full">
              <div className="flex flex-col items-center gap-3 relative self-stretch w-full">
                <Badge
                  variant="outline"
                  className="bg-neutral-50 border-[#e9e9eb] rounded-lg"
                >
                  <span className="w-fit [font-family:'Ping_AR_+_LT-Medium',Helvetica] font-medium text-[#414651] text-sm text-center leading-5 whitespace-nowrap tracking-[0] [direction:rtl]">
                    مراحل التنفيذ
                  </span>
                </Badge>

                <h2 className="relative self-stretch font-display-md-semibold font-[number:var(--display-md-semibold-font-weight)] text-[#006173] text-[length:var(--display-md-semibold-font-size)] text-center tracking-[var(--display-md-semibold-letter-spacing)] leading-[var(--display-md-semibold-line-height)] [direction:rtl] [font-style:var(--display-md-semibold-font-style)]">
                  خط سير البرنامج
                </h2>
              </div>
            </div>
