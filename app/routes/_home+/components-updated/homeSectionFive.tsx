...
import backgroundpattern from "../assets/images/new-design/Group 30545.png"
import Group30547 from "../assets/images/new-design/Group 30547.png"
    ...
    <div className="w-full min-h-screen bg-cover">
      <div className="flex flex-row mx-auto max-w-[1310px] py-9 px-4 h-full">
        ...
        <div className="relative w-full max-w-[567px] h-[756px]">
          <div className="absolute w-[494px] h-[756px] top-0 left-0 rounded-[139px] " />
          ...
          <img
            className="absolute w-[480px]   top-[238px] left-[7px]"
            alt="Background pattern"
            src={backgroundpattern}
          />
  
          <div className="absolute w-[560px] h-[349px] top-[397px] left-[7px] bg-[url(/Group 30545.png)] bg-[100%_100%]" />
            ...
            <div className="w-full flex flex-col items-center gap-12">
              <div className="w-full max-w-screen-md flex flex-col items-center gap-5">
                <div className="w-full flex flex-col items-center gap-3">
                  ...
                  <h1 className="font-display-md-medium   text-[#006173]  ">
